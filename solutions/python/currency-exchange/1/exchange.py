...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    actual_exhange_rate = exchange_rate * (1 + spread_decimal)
    transfer = budget / actual_exhange_rate
    overleft = get_leftover_of_bills(transfer, denomination)
    return int(transfer - overleft) 
