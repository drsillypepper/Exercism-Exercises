...
export function buildBirthdaySign(age) {
  let youngBirthdaySign = "Happy Birthday! What a young fellow you are.";
  let oldBirthdaySign = "Happy Birthday! What a mature fellow you are.";
  let message = age >= 50 ? oldBirthdaySign : youngBirthdaySign;
  return message;
}
...
export function costOf(sign, currency) {
  const BASECOST = 20;
  let totalCost = BASECOST + sign.length * 2;
